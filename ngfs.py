...
df = pd.read_excel(r"C:\Users\Théo DABOUT\OneDrive - NEON RISK\Documents\# DATA NGFS\DATA\#Dataset PD.xlsx", sheet_name="pass")
futur = pd.read_excel(r"C:\Users\Théo DABOUT\OneDrive - NEON RISK\Documents\# DATA NGFS\DATA\#forward_looking_ngfs.xlsx")
...
with st.sidebar:
    st.image("C:/Users/Théo DABOUT/OneDrive - NEON RISK/Documents/# DATA NGFS/NEONRISK_LOGO.png", 
             caption="NEON RISK", width=150)
    st.image("C:/Users/Théo DABOUT/OneDrive - NEON RISK/Documents/# DATA NGFS/NGFS_LOGO.jpg", 
